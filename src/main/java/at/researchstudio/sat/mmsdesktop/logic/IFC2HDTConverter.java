...
public class IFC2HDTConverter {
    ...
    public static HDT readFromFile(File ifcFile) throws IOException, ParserException {
        ...
        HDT hdt = HDTManager.generateHDT(sinkToIterator.iterator(), BASE_URI, new HDTSpecification(), null);
