...
public enum IfcPropertyType {
  TEXT("IfcText", "IFCTEXT"), LABEL("IfcLabel", "IFCLABEL"), LOGICAL("IfcLogical",
      ...
      "INTEGER"), INTEGER("IfcInteger", "IFCINTEGER"), LENGTH_MEASURE("IfcLengthMeasure",
      "IFCLENGTHMEASURE"), COUNT_MEASURE("IfcCountMeasure",
      "IFCCOUNTMEASURE"), POSITIVE_LENGTH_MEASURE("IfcPositiveLengthMeasure",
