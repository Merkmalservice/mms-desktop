...
import at.researchstudio.sat.merkmalservice.ifc.model.IfcElementQuantityLine;
...
public class IfcElementQuantityBox extends VBox {
    private static final Logger logger =
            LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

    public IfcElementQuantityBox(
        ...
        task.setOnFailed(
                event -> {
                    logger.error("IfcElementQuantityComponent Task failed:", task.getException());
