...
public abstract class StatefulTaskProgressListener implements TaskProgressListener {
    ...
    @Override
    public final void notifyProgress(String task, String message, float level) {
    ...
    public abstract void doNotifyProgress(String task, String message, float level);

    public abstract void doNotifyFinished(String task);
